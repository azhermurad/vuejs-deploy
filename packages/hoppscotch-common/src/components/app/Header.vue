    ...
    >
      ...
      >
        <!-- <ButtonSecondary
          ...
          :icon="IconLogo"
        /> -->
        <img src="./tech-specs-logo-01.png" width="100" height="100" />
        <h2 class="!font-bold !text-secondaryDark pr-3 mt-1">Playground</h2>
...
import IconLogo from "~icons/brands/logo"
